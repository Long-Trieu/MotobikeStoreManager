...
namespace QLXM_8
{
    public partial class qlkh : DevComponents.DotNetBar.Office2007RibbonForm
    {
        ...
        private void bindingdata()
        {
            ...
            txt_cmt.DataBindings.Add("Text", Grid1.DataSource, "CCCD");
        }
        #endregion
        ...
        private void InsertByAdapter()
        {
            ...
            objRow["CCCD"] = Convert.ToInt32(txt_cmt.Text);
            objDataTable.Rows.Add(objRow);
            //Tạo đối tượng Command
            OleDbCommand objCommand = new OleDbCommand();
            objCommand.Connection = objConnect;
            objCommand.CommandType = CommandType.Text;
            objCommand.CommandText = "Insert into Khach_Hang values(@STT,@MaKH,@HoTenKH,@DiaChiKH,@SDT,@CCCD)";
        ...
        private void update_dulieu()
        {
            ...
            objCommand.CommandText = "Update Khach_Hang " +
                                     "Set MaKH=@MaKH, HoTenKH=@HoTenKH, DiaChiKh=@DiaChiKH, SDT=@SDT, CCCD=@CCCD " +
                                     "Where STT=@STT";
            ...
            objCommand.Parameters.Add("@CCCD", OleDbType.Integer).Value =Convert.ToInt32(txt_cmt.Text);
        ...
        private void qlkh_Load(object sender, EventArgs e)
        {
            ...
            Grid1.Columns[5].HeaderText = "CCCD";
            #endregion
            bindingdata();
        }
