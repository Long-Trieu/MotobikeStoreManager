    ...
    public partial class qlnhanvien : DevComponents.DotNetBar.Office2007RibbonForm
    {
       ...
       // private DataTable objDataTable1;
        ...
        private void bindingdata()
        {
            ...
            txt_cCCD.DataBindings.Add("Text", Grid1.DataSource, "CCCD"); //6
        ...
        private void InsertByAdapter()
        {
            ...
            objRow["CCCD"] = Convert.ToInt32(txt_cCCD.Text);
            ...
            objCommand.Connection = objConnect;
            objCommand.CommandType = CommandType.Text;
            objCommand.CommandText = "Insert into Nhan_Vien values(@STT,@MaNV,@HoTenNV,@CCCD,@DiaChi,@ChuyenMon,@Luong)";
            ...
            objCommand.Parameters.Add("@CCCD", OleDbType.Integer, 30, "CCCD");
        ...
        private void update_dulieu()
        {
            ...
            objCommand.CommandText = "Update Nhan_Vien " +
                                     "Set MaNV=@MaNV, HoTenNV=@HoTenNV, CCCD=@CCCD, DiaChi=@DiaChi, ChuyenMon=@ChuyenMon, Luong=@Luong " +
                                     "Where STT=@STT";
            ...
            objCommand.Parameters.Add("@CCCD", OleDbType.Integer).Value = Convert.ToInt32(txt_cCCD.Text);
